 ...
 */
final class Version20211129115821 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE clicks clicks INT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE clicks clicks INT UNSIGNED DEFAULT 0');
    }
}
